...
# 0x0054–0x0057 SD 容量（MiB，32 位）
IR_SD_TOTAL_MB_H = 0x0054
IR_SD_TOTAL_MB_L = 0x0055
IR_SD_FREE_MB_H = 0x0056
IR_SD_FREE_MB_L = 0x0057

# 0x0058–0x0059 电池/参考电压（mV）
IR_BATTERY_MV = 0x0058
IR_VDDA_MV = 0x0059
