...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : LED_GREEN_Pin LED_YELLOW_Pin LED_RED_Pin PWR_ON_Pin
                           SD_PWR_EN_Pin */
  GPIO_InitStruct.Pin = LED_GREEN_Pin|LED_YELLOW_Pin|LED_RED_Pin|PWR_ON_Pin
                          |SD_PWR_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : ON_OFF_Pin KEY_PWR_Pin */
  GPIO_InitStruct.Pin = ON_OFF_Pin|KEY_PWR_Pin;
